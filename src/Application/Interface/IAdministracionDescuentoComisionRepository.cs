...
public interface IAdministracionDescuentoComisionRepository
{
    ...
    Task<(IEnumerable<ProrrateoDisponibleDescuento> Data, bool Success, string Mensaje)> GetProrrateosDisponibles(string LogTransaccionId, int LCicloId, int LContactoId);
